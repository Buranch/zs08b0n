...
const findHighestInterceptedLocation = (sortedLocations, filteredLocations) =>
  sortedLocations.find((location) => filteredLocations
  .some((filteredLocation) => location === filteredLocation));
